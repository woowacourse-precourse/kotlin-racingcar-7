...
- [ ] 자동차 전진 기능
    - 무작위 값이 4 이상일 경우
- [ ] 레이스 참가 자동차 이름 중복 검사 기능
- [ ] 레이스 참가 자동차 2대 이상인지 확인하는 기능
- [ ] 0 ~ 9 사이의 랜덤 숫자 반환 기능
- [ ] 단독 우승자 판별 기능
- [ ] 공동 우승자 판별 기능
- [ ] 우승자 출력 기능
...
- [ ] 자동차의 이름이 1 ~ 5 글자가 아닌 경우
- [ ] 자동차의 이름이 공백을 포함하였을 경우
- [ ] 자동차의 이름이 줄바꿈을 포함하였을 경우
- [ ] 자동차의 이름이 중복 되었을 경우
- [ ] 레이싱의 참여하는 자동차가 2대 이상이 아닐 경우
- [ ] 레이스의 참여하는 자동차의 정보를 입력하지 않았을 경우
...
- [ ] 입출력을 제외한 구현 기능 별 1개 이상의 테스트가 완료되어야 한다.
    - [ ] 자동차 이름 길이 확인 테스트 구현
    - [ ] 자동차 이름 공백 여부 확인 테스트 구현
    - [ ] 자동차 이름 줄바꿈 여부 확인 테스트 구현
    - [ ] 레이스에 참가하는 자동차의 이름 중복 여부 확인 테스트 구현
    - [ ] 레이스에 참가하는 자동차의 수 확인 테스트 구현
    - [ ] 레이스에 참여하는 자동차 정보 입력 여부 확인 테스트 구현
